        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.client.update', $client->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="url" name="url" value="{{ old('url', $client->url) }}">
                    @if ($errors->has('url'))
                ...
                <div class="form-group">
                    <p><img src="{{ Storage::url($client->logo) }}" alt=""></p>
                    <label for="logo" class="form-control-label">شعار العميل <span class="text-danger">*</span> </label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="order" name="order" value="{{ old('order', $client->order) }}">
                    @if ($errors->has('order'))
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="is_menu" name="is_menu">
                        <option value="1" {{ old('is_menu', $client->is_menu) == 1 ? 'selected' : '' }}>ظاهر</option>
                        <option value="0" {{ old('is_menu', $client->is_menu) == 0 ? 'selected' : '' }}>مخفي</option>
                    </select>
