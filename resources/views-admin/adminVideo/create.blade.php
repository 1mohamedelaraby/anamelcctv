            ...
            <form action="{{ route('admin.videos.store') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="video_category_id" name="video_category_id">
                        ...
                        <option value="{{ $item->id }}" {{ old('video_category_id') == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <textarea rows="15" class="form-control editor" id="description" name="description">{{ old('description') }}</textarea>
