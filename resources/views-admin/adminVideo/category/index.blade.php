...
<div class="container-fluid">
    <a href="{{ route('admin.videoCategory.create') }}" class="btn btn-outline-success">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">اقسام الفيديوهات</div>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="fit">{{ $item->videos_count }}</td>
                                    <td class="fit">
                                        <form action="{{ route('admin.videoCategory.destroy', $item->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <a href="{{ route('admin.videoCategory.edit',[$item->id]) }}" class="text-info">
