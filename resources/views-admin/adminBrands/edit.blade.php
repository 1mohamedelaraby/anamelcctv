        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.brand.update', $brand->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea rows="15" class="form-control" id="description" name="description">{{ old('description', $brand->description) }}</textarea>
                ...
                <div class="form-group">
                    <p><img src="{{ Storage::url($brand->logo) }}" alt=""></p>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="order" name="order" value="{{ old('order', $brand->order) }}">
                    @if ($errors->has('order'))
