                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="{{ $order->status == 'تم الإلغاء' ? 'text-danger' : '' }}">{{ $order->user->name }} <br> {{ $order->email }} <br> {{ $order->phone }}
                                    </td>
                                    ...
                                    <td class="fit">
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('admin.shop.order.show', $order->id) }}">عرض</a>
                                                {{-- <a class="dropdown-item" href="#">تعديل</a> --}}
                                                @permitTo('UpdateOrder')
                                                @if ($order->paid)
                                                <form action="{{ route('admin.shop.order.changePaymentStatus', $order->id) }}" method="POST">
                                                    @csrf
                                                ...
                                                @endif
                                                <form action="{{ route('admin.shop.order.changeOrderStatus', $order->id) }}" method="POST">
                                                    @csrf
