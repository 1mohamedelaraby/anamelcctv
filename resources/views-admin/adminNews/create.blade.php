...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            <h6 class="card-body-title">بيانات جديدنا</h6>
            <p class="mg-b-20 mg-sm-b-30">برجاء التحقق من البيانات قبل الحفظ</p>

            <form action="{{ route('admin.news.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label for="title" class="form-control-label">العنوان <span class="text-danger">*</span> </label>
                ...
                <div class="form-group">
                    ...
                    <select name="featured" id="featured" class="form-control">
                        ...
                        <option value="0" {{ old('featured') === '0'?'selected':'' }}>غير مميز</option>
                        <option value="1" {{ old('featured') == 1?'selected':'' }}>مميز</option>
                    </select>
