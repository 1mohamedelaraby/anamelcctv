        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.testimonial.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="url" class="form-control" id="profile_photo_url" name="profile_photo_url" value="{{ old('profile_photo_url') }}">
                ...
                <div class="form-group">
                    ...
                    <textarea rows="15" class="form-control" id="text" name="text">{{ old('text') }}</textarea>
                    @if ($errors->has('text'))
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="status" name="status">
                        <option value="0" {{ old('status') == 0?'selected':'' }}>غير منشور</option>
                        <option value="1" {{ old('status') == 1?'selected':'' }}>منشور</option>
                    </select>
