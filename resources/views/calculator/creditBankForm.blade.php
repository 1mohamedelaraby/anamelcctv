...
@section('title', ' - اتمام عملية الشراء')
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-10">
                            ...
                            <div class="block">
                                ...
                                <p>المبلغ المطلوب {{ $calculator->total_price }} ريال</p>
                                <div>
                                    <form action="{{ route('calculator.payment', $calculator->id) }}" class="paymentWidgets" data-brands="VISA MASTER AMEX">
                                        @csrf
                                        VISA MASTER AMEX
                                    </form>
                                </div>
