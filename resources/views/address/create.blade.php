    ...
    <div class="flex md:items-center">
        <div class="w-full">
            <div class="flex justify-between items-center">
                <h3 class="text-3xl font-bold text-blue-900">اضافة عنوان</h3>
            </div>
            <hr class="pb-6 mt-6">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input
                            ...
                            name="phone" id="phone" type="text" placeholder="0512345678" value="{{ old('phone') }}" pattern="05[0-9]{8}">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <input
                            ...
                            name="address" id="address" type="text" placeholder="121 اسم الشارع - المنطقة - الحي" value="{{ old('address') }}">
                ...
                <div class="flex flex-wrap -mx-3 mb-2">
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        <input
                            ...
                            name="street_no" id="street_no" type="text" placeholder="121" value="{{ old('street_no') }}">
                    </div>
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        <input
                            ...
                            name="area" id="area" type="text" placeholder="الشارقة" value="{{ old('area') }}">
                    </div>
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        <input
                            ...
                            name="building" id="building" type="text" placeholder="4562" value="{{ old('building') }}">
                    </div>
                </div>
                ...
                <div class="flex flex-wrap -mx-3 mb-2">
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        <input
                            ...
                            name="floor" id="floor" type="text" placeholder="9" value="{{ old('floor') }}">
                    </div>
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        <input
                            ...
                            name="apartment" id="apartment" type="text" placeholder="2" value="{{ old('apartment') }}">
                    </div>
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        <input
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            name="postcode" id="postcode" type="text" placeholder="22152" value="{{ old('postcode') }}">
                    </div>
                </div>
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <input
                            ...
                            name="nearest" id="nearest" type="text" placeholder="بجوار مكتبة الأمة" value="{{ old('nearest') }}">
                    </div>
                </div>
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <textarea
                            ...
                            name="notes" id="notes" type="text" placeholder="بجوار مكتبة الأمة">{{ old('notes') }}</textarea>
                    </div>
                </div>
