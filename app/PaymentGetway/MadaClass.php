...
class MadaClass implements PaymentGetwayInterface
{
    ...
    public function pay(Order $order)
    {
        ...
        if (is_object(json_decode($bankResponse))) {
            ...
            return redirect()->route('order.madaBankForm', [$order->id, $checkoutId]);
        } else {
    ...
    public function bankResponse($price, $order, $prefix = null)
    {
        ...
        $data = "entityId=8ac9a4ce74b532ef0174b56804b702ae" .
            //"&testMode=EXTERNAL" .
            "&amount=" . $price .
            "&currency=SAR" .
    ...
    public function completePayment($id)
    {
        ...
        $url .= "?entityId=8ac9a4ce74b532ef0174b56804b702ae";
